                    ...
                    <v-row no-gutters>
                      ...
                      <v-col cols="12">
                        <v-select
                          ...
                          :item-text="
                            (item) =>
                              `Lote: ${item.client.name} - ${item.number}`
                          "
                    ...
                    <v-col cols="12" md="4">
                      <div>
                        ...
                        <v-chip
                          ...
                          outlined
                          :color="
                            selected.lot.is_delivered == 1 ? 'green' : 'red'
                          "
                          >{{
                            selected.lot.is_delivered == 1
                              ? "Entregado"
                              : "Pendiente"
                          }}</v-chip
                        >
                    ...
                    <v-col md="8" cols="12">
                      ...
                      <v-row v-if="selected.status_id == 3">
                        ...
                        <v-col>
                          <h6>Fila del rack</h6>
                          <v-text-field
                            :value="selected.currentLocker.row"
                            readonly
                            autofocus
                          ></v-text-field>
                        </v-col>
                      ...
                      <div v-else>
                        El paquete actualmente no se encuentra colocado en
                        bodega y no tiene un locker asignado.
                      </div>
                    </v-col>
                  </v-row>
                </v-card-text>
